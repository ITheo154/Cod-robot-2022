...
public class Autonoma_remote extends LinearOpMode {
    ...
    */
    ...
    //servos
    Servo control, retragere1, retragere2, cutie;

    //dcMotors
    DcMotor intake1, intake2, extindere;
...
//         first.
    ...
    private void caz_mijloc() {
        ...
        moveToPosition(-12,0.6);
        //
        strafeToPosition(-48.8, 0.2);
        //
        turnWithGyro(-180, -0.2);
        //
        moveToPosition(-11.4, 0.2);
        //
        strafeToPosition(-66.6, 0.2);
        //
        moveToPosition(-14.6, 0.2);
        //
        turnWithGyro(90, 0.2);
        //
        moveToPosition(-47.4, 0.2);
        //
        requestOpModeStop();
